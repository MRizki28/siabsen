...
@section('content')
    <style>
        ...
        /* Add a transparent background on hover */
        .btn-csv:hover,
        .btn-excel:hover {
    ...
    <div class="card">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            ...
            <button type="button" class="btn btn-outline-primary ml-auto" data-toggle="modal" data-target="#DivisiModal"
                id="#myBtn">
                Absen otomatis yang tidak hadir
            </button>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Lakukan absen untuk user yang tidak hadir </p>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                url: "{{ url('v2/febba411-89e8-4fb3-9f55-85c56dcff41d/absen') }}",
                method: "GET",
                dataType: "json",
        ...
        $(document).ready(function() {
            ...
            formTambah.on('submit', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ url('v2/396d6585-16ae-4d04-9549-c499e52b75ea/admin/control') }}',
                    data: formData,
                    dataType: 'JSON',
                    contentType: false,
                    processData: false,
